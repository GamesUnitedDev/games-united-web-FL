...
function PrivacyNotice({ pdf }: Props) {
  ...
  return (
    <>
      <Meta
        title={t('legal.tt.end-user-license-and-service.meta.title')}
        description={t(
          'legal.tt.end-user-license-and-service.meta.description'
        )}
      />
      <Navbar />
        ...
        <section className="flex min-h-[40vh] w-full items-center justify-center bg-primary-purple pt-[200px]">
          <section className="flex w-full max-w-theme items-start justify-start p-5">
            <h1 className="text-left text-2xl font-black text-white lg:text-5xl">
              {t('legal.tt.end-user-license-and-service.title')}
            </h1>
          </section>
        </section>
...
export async function getServerSideProps({ locale }) {
  const pdfs = {
    tr: '/assets/legal/towertactix/end-user-license-and-service-en.pdf',
    en: '/assets/legal/towertactix/end-user-license-and-service-en.pdf',
  };
