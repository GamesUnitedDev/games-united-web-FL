...
function PrivacyNotice({ pdf }: Props) {
  ...
  return (
    <>
      <Meta
        title={t('legal.luckywarrior.childrens-privacy.meta.title')}
        description={t('legal.luckywarrior.childrens-privacy.meta.description')}
      />
      <Navbar />
        ...
        <section className="flex min-h-[40vh] w-full items-center justify-center bg-primary-purple pt-[200px]">
          <section className="flex w-full max-w-theme items-start justify-start p-5">
            <h1 className="text-left text-2xl font-black text-white lg:text-5xl">
              {t('legal.luckywarrior.childrens-privacy.title')}
            </h1>
          </section>
        </section>
...
export async function getServerSideProps({ locale }) {
  const pdfs = {
    tr: '/assets/legal/luckywarrior/childrens-privacy-en.pdf',
    en: '/assets/legal/luckywarrior/childrens-privacy-en.pdf',
  };
